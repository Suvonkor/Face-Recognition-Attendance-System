...
class Login_Window:
    def __init__(self,root):
        ...
        img1 = img1.resize((1530,800), Image.LANCZOS)
        ...
        img10 = img10.resize((500,120), Image.LANCZOS)
        ...
        img11 = img11.resize((500,120), Image.LANCZOS)
        ...
        img13 = img13.resize((550,120), Image.LANCZOS)
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            conn=mysql.connector.connect(host="localhost",user="root",password="Rounak@2001",database="facial_recognition")
