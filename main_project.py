...
class FaceRecognitionSystem:
    def __init__(self,root):
        ...
        # img13 = img13.resize((550,100), Image.LANCZOS)
        ...
        img1 = img1.resize((1600,710), Image.LANCZOS)
