...
class Student:
    def __init__(self,root):
        ...
        img10 = img10.resize((1300,70), Image.LANCZOS)
        ...
        # img10 = img10.resize((400,130), Image.LANCZOS)
        # self.photoImg10 = ImageTk.PhotoImage(img10)
        # bg_lbl1=Label(self.root,image=self.photoImg10)
        ...
        # img11 = img11.resize((400,130), Image.LANCZOS)
        ...
        # img13 = img13.resize((450,130), Image.LANCZOS)
        ...
        # img1 = img1.resize((1250,710), Image.LANCZOS)
        ...
        img20 = img20.resize((550,200), Image.LANCZOS)
        ...
        img30 = img30.resize((320,70), Image.LANCZOS)
    ...
    def add_data(self):
        if (self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_roll.get()=="" or self.usertype.get()==""):
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Rounak@2001",database="facial_recognition")
